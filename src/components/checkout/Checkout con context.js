...
function CheckoutConContext () {
    ...
    const {purchase, addPurchase } = useContext(PurchaseContext);
    ...
    const addOrder =  (e) => {
       ...
       console.log ("esta es myorder local", myOrder)
       console.log ("esta es la orden en state:", order)
        ...
        console.log ("voy a agregar la compra al context", myOrder)
        addPurchase(myOrder)
        console.log ("COMPRA agregada al context OK", purchase)
      };
    ...
    return (
        ...
        <Container>
            ...
            <button className="btn btn-warning btn-lg" onClick={addOrder}>Probar variable estado Order </button>
...
export default CheckoutConContext