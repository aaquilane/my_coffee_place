...
function Checkout() {
  const { cartQuantity, cartPrice, cartProducts, emptyCart } =
    ...
    <>
      ...
      <Container>
        ...
        <Row>
          <Col>
            <div className="mb-3">
              <input
                ...
                onBlur={(e) =>
                  handleEmail(e.target.value, inputRepeatMail.value)
                }
                value={inputMail}
              />
            </div>
          ...
          <Col>
            <div className="mb-3">
              ...
              />
              <p>
                <font color="red"> {inputRepeatMail.errMessage}</font>
              </p>
            </div>
          </Col>
        </Row>
          ...
          <Col>
            ...
            <div className="form-check">
              <input
                ...
                type="radio"
                value="Pick up"
                checked={inputFulfillment === "Pick up"}
              ...
              <input
                ...
                type="radio"
                value="Delivery"
                checked={inputFulfillment === "Delivery"}
                name="radioFulfillment"
                id="radioDelivery"
                onChange={handleFulfillment}
              />
          ...
          <Col>
            ...
            <div className="form-check">
              <input
                ...
                type="radio"
                value="Cash"
                checked={inputPaymentMethod === "Cash"}
                name="radioPayment"
                id="radioCash"
            ...
            <div className="form-check">
              <input
                ...
                type="radio"
                value="Credit card"
                checked={inputPaymentMethod === "Credit card"}
                name="radioPayment"
                id="radioCredit"
                onChange={handlePaymentMethod}
              />
            ...
            <div className="form-check">
              <input
                ...
                type="radio"
                value="Debit card"
                checked={inputPaymentMethod === "Debit card"}
                name="radioPayment"
                id="radioDebit"
                onChange={handlePaymentMethod}
              />
        ...
        <div className="d-grid gap-2 col-6 mx-auto">
          <button className="btn btn-warning btn-lg" onClick={addOrder}>
            Purchase ${cartPrice}{" "}
          </button>
      ...
      <ShowConfirmation
        myOrder={order}
        showSuccess={purchaseOk}
        onCleanCart={emptyCart}
      />
    </>
  );
}
